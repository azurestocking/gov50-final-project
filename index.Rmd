...
df |>
  ...
  labs(title = "Regression of CNT on Weather Inclemency",
...
df |>
  ...
  geom_point() +
  geom_smooth(method = "lm", se = FALSE) +
  labs(title = "Regression of CNT on Feeling Temperature",
...
df |>
  ...
  geom_point() +
  geom_smooth(method = "lm", se = FALSE) +
  labs(title = "Regression of CNT on Humidity",
...
df |>
  ...
  geom_point() +
  geom_smooth(method = "lm", se = FALSE) +
  labs(title = "Regression of CNT on Wind Speed",
